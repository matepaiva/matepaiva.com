angular.module("portfolio").controller("panelDevCtrl", function($scope) {
    ...
    $scope.jobs = [{
        ...
        imgBaseurl: "img/clients/month-calendar/",
        imgs: [{
            size: 2,
            src: "img.png"
        }],
        ...
        imgBaseurl: "img/clients/carousel/",
        imgs: [{
            size: 2,
            src: "img.png"
        }],
