angular.module("portfolio").controller("panelJorCtrl", function($scope, $window) {
    ...
    $scope.jobs = [{
        ...
        imgBaseurl: "img/clients/artidea/",
        imgs: [{
            size: 1,
            src: "img6.png"
        }, {
        ...
        imgBaseurl: "img/clients/volkswagen/",
        imgs: [{
            size: 2,
            src: "img1.png"
        }, {
        ...
        imgBaseurl: "img/clients/minsaude-fiquesabendo/",
        imgs: [{
            size: 3,
            src: "img1.png"
        }, {
        ...
        imgBaseurl: "img/clients/minsaude-saudenaescola/",
        imgs: [{
            size: 2,
            src: "img1.png"
        }, {
        ...
        imgBaseurl: "img/clients/minsaude-usecamisinha/",
        imgs: [{
            size: 2,
            src: "img6.png"
        }, {
        ...
        imgBaseurl: "img/clients/cupnoodles/",
        imgs: [{
            size: 2,
            src: "img1.png"
        }, {
        ...
        imgBaseurl: "img/clients/redbull/",
        imgs: [{
            size: 1,
            src: "img1.png"
        }, {
        ...
        imgBaseurl: "img/clients/renault/",
        imgs: [{
            size: 2,
            src: "img1.png"
        }, {
